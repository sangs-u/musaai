...
2. core.js / style.css / index.html 수정 시 반드시 다른 파일 영향 확인
3. plan-template.js 수정 시 스모크 테스트(console.assert) 통과 확인
4. PDF 출력 관련 작업 시 기존 레이아웃 깨지지 않도록 주의
5. 완료 후 변경된 파일명과 라인 수 보고
6. 외국인 근로자 다국어 지원 고려 (2025-외국인안전답팀 파일 존재)
